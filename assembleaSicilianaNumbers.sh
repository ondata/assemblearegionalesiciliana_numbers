...
csvsql -I --query "select * FROM tmp_attivitaDeputatiRegioneSiciliana_04 group by idDeputato" ./tmp_attivitaDeputatiRegioneSiciliana_04.csv > ./attivitaDeputatiRegioneSiciliana.csv
